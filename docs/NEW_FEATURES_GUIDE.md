...
## 🛡️ 提醒避开周末 (Avoid Weekends)

### 场景描述
在人力外包管理中，许多重要的合同到期提醒如果落在周六或周日，可能会被漏掉或无法及时处理。

### 功能说明
- **智能调整**：如果计算出的提醒日期是**周六**，系统会自动将其提前至**周五**。
- **智能调整**：如果计算出的提醒日期是**周日**，系统会自动将其提前至**周五**。
- **确保及时性**：保证所有提醒都在工作日（周一至周五）发出，确保项目助理能及时看到通知。

### 如何启用
1. 进入 **Settings** 页面。
2. 在 **Reminder Rules** 列表中，找到你想修改的标签（如：合同）。
3. 点击编辑（或新增规则）。
4. 勾选 **"Avoid Weekends (Adjust to Friday)"** 选项。
5. 点击保存。
